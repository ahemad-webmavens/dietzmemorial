...
@section('content')
    ...
    {{-- Hero Banner --}}
    <div
        style="background-image: url('{{ asset('storage/pages/services-banner.webp') }}'); background-size: cover; background-position: center; background-repeat: no-repeat; position: relative; padding: 120px 24px; text-align: center; margin-bottom: 50px; border-top: 3px solid #c8a96e;">
        ...
        <div style="position: relative; z-index: 1;">
            <p
                style="color: #c8a96e; font-size: 0.75rem; font-weight: 600; letter-spacing: 0.2em; text-transform: uppercase; margin-bottom: 12px;">
                What We Offer
            </p>
            <h1
                style="color: #ffffff; font-size: clamp(2rem, 5vw, 3rem); font-weight: 700; margin-bottom: 16px; font-family: serif;">
                Our Services
            </h1>
            <p
                style="color: rgba(255,255,255,0.85); font-size: 1.05rem; max-width: 560px; margin: 0 auto; line-height: 1.7;">
    ...
    <div class="max-w-7xl mx-auto px-4" style="padding-bottom: 50px;">
                ...
                <div style="background: #ffffff; border-radius: 10px; overflow: hidden; box-shadow: 0 2px 12px rgba(0,0,0,0.08); display: flex; flex-direction: column; transition: box-shadow 0.25s ease, transform 0.25s ease;"
                    ...
                    @if ($service->image)
                        <div style="position: relative; overflow: hidden; height: 220px;">
                            ...
                            {{-- Gold accent bar --}}
                            <div
                                style="position: absolute; bottom: 0; left: 0; right: 0; height: 3px; background-color: #c8a96e;">
                            </div>
                        </div>
                    @else
                        {{-- Placeholder if no image --}}
                        <div
                            style="height: 220px; background-color: #4a5e3a; display: flex; align-items: center; justify-content: center;">
                    ...
                    <div style="padding: 24px; display: flex; flex-direction: column; flex: 1;">
                        ...
                        <h2
                            style="color: #2d2d2d; font-size: 1.3rem; font-weight: 700; margin-bottom: 10px; font-family: serif; line-height: 1.3;">
                            {{ $service->name }}
                        </h2>
        ...
        {{-- Bottom CTA --}}
        <div
            style="margin-top: 50px; background-color: #4a5e3a; border-radius: 12px; padding: 48px 32px; text-align: center;">
            <p
                style="color: #c8a96e; font-size: 0.75rem; font-weight: 600; letter-spacing: 0.2em; text-transform: uppercase; margin-bottom: 12px;">
                Need Guidance?
            </p>
            ...
            <p
                style="color: rgba(255,255,255,0.75); font-size: 0.95rem; margin-bottom: 28px; max-width: 480px; margin-left: auto; margin-right: auto; line-height: 1.7;">
